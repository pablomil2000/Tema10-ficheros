        ...
        <div class="container-fluid">
            <h2>
                <div class="row">
                    ...
                    <div class="hero-unit">
                        <!-- <form id="newsletter" action="../codigo/principal.php?admin_baja" method="POST"> -->
                            <h3>Formulario Selecciona Nombre</h3>
                            <select name="palabra1">
                                <option value="">Seleccione:</option>
                                <?php
                                for ($i = 0; $i < count($palabra1) - 1; $i++) {
                                    echo '<option value="' . $palabra1[$i] . '">' . $palabra1[$i] . ' </option>';
                                }
                                ?>
                            </select>
                            <input type="text" name="cambiar" placeholder="Cambiar">
                            <br />
                            <br />
